    ...
    function B(t, u, g) {
        return {
            restrict: "ECA", terminal: !0, priority: 400, transclude: "element", link: function (a, f, b, c, m) {
                ...
                var l, n, p, w = b.autoscroll, k = b.onload || "";
    ...
    var y,
        E, F, z = d.module("ngRoute", []).provider("$route", function () {
            ...
            this.when = function (a, f) {
                ...
                } else if (E(f))for (c in b = b || {}, f)if ("$" !== c.charAt(0) || "$" !== c.charAt(1))b[c] = f[c];
                b = b || f;
            ...
            this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest", "$sce", function (a, f, b, c, m, k, u) {
                ...
                function p(e) {
                    ...
                    if (e)if (e.redirectTo)if (d.isString(e.redirectTo))a.path =
                        x(e.redirectTo, e.params), a.search = e.params, a.hasRedirection = !0; else {
